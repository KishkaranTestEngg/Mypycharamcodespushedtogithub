...
from POM.Dashboardpage import Dashboard
from POM.LoginpagePOM import Login
...
def test_login_scenario():
    ...
    URL_of_dashboardpage = user_login.login_()
    if URL_of_dashboardpage == 'https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index':
